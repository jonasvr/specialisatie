var plotly = require('plotly')('jonasvr', 'kw6ismsj68');
...
board.on("ready", function() {
  ...
  plotly.plot(data,layout,function (err, res) {
    ...
    //to pipe your data!
    var stream = plotly.stream('1m0f7uc5z6', function (err, res) {
      if (err) console.log(err);
      console.log(res);
    });

    var stream_2 = plotly.stream('cj8b1e17aw', function (err, res) {
      if (err) console.log(err);
      console.log(res);
    });
