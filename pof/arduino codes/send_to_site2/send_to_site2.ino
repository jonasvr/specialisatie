...
char ssid[] = "telenet-09E47";  // wireless network name
char password[] = "9920592504"; // wireless password
int status = WL_IDLE_STATUS;
WiFiClient client;

// EDIT: 'Server' address to match your domain
char server[] = "www.jonastests.eu"; // This could also be 192.168.1.18/~me if you are running a server on your computer on a local network.

// This is the data that will be passed into your POST and matches your mysql column
int yourarduinodata = 1;
...
void postData() {
  ...
  if (client.connect(server, 80)) {
    ...
    client.println("POST /add3.php HTTP/1.1");

    // EDIT: 'Host' to match your domain
    client.println("Host: www.jonastests.eu");
