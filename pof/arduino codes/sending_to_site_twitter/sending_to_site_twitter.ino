...
Twitter twitter("2422087854-gTM4Re3WULWOJsrF2qKjjoItfm7r2sEyzUx2R3G");
...
void SitePost(digi){
   if (client.connect("ns1-155.axc.nl",80)) { // REPLACE WITH YOUR SERVER ADDRESS
        data = "data=" + digi;
        client.println("POST /add.php HTTP/1.1"); 
        client.println("ns1-155.axc.nl"); // SERVER ADDRESS HERE TOO
...
void TwitterPost(digi){
  if (digi == 0)
  {
    msg =  'Brabokot is gesloten';
   }
   else
   {
    msg = 'Brabokot is open11';
    }
     if (twitter.post(msg)) {
